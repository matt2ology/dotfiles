# External plugins are plugins that are not managed by this repository.
# Is initalized after the rest of the shell is initialized.
# This is useful for plugins that depend on the shell being initialized.
# For example: the `zsh-autosuggestions` plugin depends on the `zsh-syntax-highlighting` plugin.
